...
const Tema2CC_1 = require("../api_routes/Tema2CC");
const FloareController_1 = require("../api_routes/FloareController");
const fs = require('fs');
...
MyRouter.mapPut = {};
MyRouter.mapDelete = {};
new Tema2CC_1.Tema2CC;
new FloareController_1.FloareController;
